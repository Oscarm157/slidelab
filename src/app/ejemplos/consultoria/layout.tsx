...
import { consultoriaConfig } from "./deck.config";

const literata = Literata({ variable: "--font-serif", subsets: ["latin"], weight: ["400", "600", "700"] });
const sans = DM_Sans({ variable: "--font-jakarta", subsets: ["latin"], weight: ["400", "500", "600", "700"] });
...
export default function ConsultoriaLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className={`${literata.variable} ${sans.variable} ${mono.variable}`}
