...
import { realEstateConfig } from "./deck.config";

const playfair = Playfair_Display({ variable: "--font-serif", subsets: ["latin"], weight: ["400", "600", "700"] });
const inter = Inter({ variable: "--font-jakarta", subsets: ["latin"], weight: ["400", "500", "600", "700"] });
const mono = DM_Mono({ variable: "--font-dm-mono", subsets: ["latin"], weight: ["400", "500"] });

export default function RealEstateLayout({ children }: { children: React.ReactNode }) {
  const { theme } = realEstateConfig;
  ...
  return (
    <div className={`${playfair.variable} ${inter.variable} ${mono.variable}`}
